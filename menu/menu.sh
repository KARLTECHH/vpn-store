...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/KARLTECHH/izin/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/KARLTECHH/izin/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/KARLTECHH/izin/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/KARLTECHH/izin/main/ip | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/KARLTECHH/vpn-store/main/versions)
...
figlet 'VPN-STORE'
echo -e "${BIPurple} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BIPurple} │                  ${BIWhite}${UWhite}KARLSTORE${NC}"
echo -e "${BIPurple} │"
...
11) clear ; wget https://raw.githubusercontent.com/KARLTECHH/vpn-store/main/kyt.sh && chmod +x kyt.sh && ./kyt.sh ;;
12) clear ; lock ;;
13) clear ; unlock ;;
14) clear ; update ;;
0) clear ; menu ;;
